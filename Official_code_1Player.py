...
# TODO: NORMAL #########################################################################################################
        ...
        self.planets = [Planet('Marte', 1, 10, 'normal', {'mu': 5, 'sigma': 1}),
                        Planet('Venere', 2, 10, 'normal', {'mu': 6, 'sigma': 1.5}),
                        Planet('Urano', 3, 10, 'normal', {'mu': 6, 'sigma': 2})]
        # Creation of the first spacecraft (aka ship)
        self.ship1 = Ship('Enterprise', 200, 1, 'mab_tempo', self.planets)
        # Creation of the second spacecraft (aka ship)
        #self.ship2 = Ship('Millennium Falcon', 200, 1, 'epsilonGreedy', self.planets)
# TODO: DIFFERENT ######################################################################################################
        # Creation of the planets
        #self.planets = [Planet('Marte', 1, 10, 'normal', {'mu': 6, 'sigma': 1.5}),
        #                Planet('Venere', 2, 10, 'poisson', {'mu': 5}),
        #                Planet('Urano', 3, 10, 'negative_binomial', {'mu': 18, 'sigma': 0.75})]
        # Creation of the first spacecraft (aka ship)
...
#    'C:/Users/davla/Desktop/output_per_prof/MeanStrategy/1Player_42_gauss_gauss_gauss_EpsilonGreedy_MeanStrategy.xlsx')
